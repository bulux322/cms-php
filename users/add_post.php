        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li> <i class="fa fa-dashboard"></i> <a href="/">Deshboard</a> </li>
                ...
                if(isset($_POST['create_post'])){
                    ...
                    if(!empty($_FILES['image']['name'])){
                        ...
                        if(!in_array($file_ext, $allowed_ext)){
                            echo "<div class='alert alert-danger'>Only JPG and PNG images are allowed.</div>";
                            $upload_error = true;
                        }
                        ...
                        if($file_size > 512000){
                            echo "<div class='alert alert-danger'>Image size must be under 500KB.</div>";
                            $upload_error = true;
                        }

                        if(!$upload_error){
                            $post_image = uniqid('post_', true) . '.' . $file_ext;
                            move_uploaded_file($file_tmp, "../images/post_pic/$post_image");
                        }
                    }
