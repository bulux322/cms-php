							...
							<div class="container text-center">
								<div class="row">
									<div class="col-sm-3 well">
										<div><img src="images/user_pic/<?php echo $user_image ?? 'no_avatar.gif'; ?>" class="img-circle" height="85" width="85" alt="<?php echo $username; ?>">
											<br>
											<br>
										...
										<div class="well">
											...
											$tags = explode(',', $user_interests ?? 'Find Interest');
											foreach ($tags as $tag) {
